		...
		return html`
			<div class="relative isolate bg-white pt-24 pb-32 sm:pt-32">
				...
				<div class="absolute inset-y-0 bottom-40 -z-10 translate-y-1/4 transform-gpu overflow-hidden opacity-30 blur-3xl" aria-hidden="true">
					<div class="mr-[max(50%,38rem)] aspect-1313/771 w-[82.0625rem] bg-linear-to-tr from-[#008080] to-[#4bc0f2]" style="clip-path: polygon(74.1% 44.1%, 100% 61.6%, 97.5% 26.9%, 85.5% 0.1%, 80.7% 2%, 72.5% 32.5%, 60.2% 62.4%, 52.4% 68.1%, 47.5% 58.3%, 45.2% 34.5%, 27.5% 76.7%, 0.1% 64.9%, 17.9% 100%, 27.6% 76.8%, 76.1% 97.7%, 74.1% 44.1%)"></div>
				</div>
					...
					<div class="mx-auto mt-16 grid max-w-2xl grid-cols-1 grid-rows-1 gap-8 text-sm/6 text-gray-900 sm:mt-20 sm:grid-cols-2 xl:mx-0 xl:max-w-none xl:grid-rows-1 xl:grid-flow-col xl:grid-cols-4">
						<figure class="rounded-2xl bg-white shadow-lg ring-1 ring-gray-900/5 sm:col-span-2 xl:col-start-2 xl:row-end-1">
							<blockquote class="p-6 text-lg font-semibold tracking-tight text-gray-900 sm:p-12 sm:text-xl/8">
								<p>“1000 Dank nochmal... Ich habe sowas noch nie erlebt... Es hat alles gestimmt, sooo viele Informationen, das hättest du niemals von irgendjemand wissen können... Alles hat zu 100 Prozent gepasst... Es war magisch!!! Ich danke dir von ganzem Herzen!!!!”</p>
							</blockquote>
							...
							<div class="space-y-8 xl:row-span-2">
								<figure class="rounded-2xl bg-white shadow-lg ring-1 ring-gray-900/5">
									...
									<figcaption class="mt-6 flex-wrap flex items-center gap-x-4 border-t border-gray-900/10 px-6 py-4">
										<div>
											<div class="font-semibold">Stojanka Alexandropulus</div>
										</div>
									</figcaption>
								</figure>
								...
								<figure class="rounded-2xl bg-white shadow-lg ring-1 ring-gray-900/5">
									...
									<figcaption class="mt-6 flex-wrap flex items-center gap-x-4 border-t border-gray-900/10 px-6 py-4">
										<div>
											<div class="font-semibold">Bla bla</div>
										</div>
									</figcaption>
								</figure>
						...
						<div class="space-y-8 xl:contents xl:space-y-0">
							...
							<div class="space-y-8 xl:row-span-2">
								<figure class="rounded-2xl bg-white shadow-lg ring-1 ring-gray-900/5">
									...
									</blockquot px-6e>y<figcaption class="mt-6 flex-wrap flex items-center gap-x-4 border-t border-gray-900/10 px-6 py-4">
										<div>
