      ...
      return html`
	      <main class="relative isolate min-h-full">
		      ...
		      <div class="mx-auto max-w-7xl px-6 py-32 text-center sm:py-40 lg:px-8">
			      ...
			      <h1 class="mt-4 text-5xl font-semibold tracking-tight text-balance text-white sm:text-7xl">Page not
				      found</h1>
			      <p class="mt-6 text-lg font-medium text-pretty text-white/70 sm:text-xl/8">Sorry, we couldn’t find the page
